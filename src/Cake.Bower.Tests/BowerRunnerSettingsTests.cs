...
namespace Cake.Bower.Tests
{
    ...
    {
        private readonly BowerCacheFixture fixture = new BowerCacheFixture(); // Any fixture will do here

        [Fact]
        public void Force_Setting_Adds_Switch_To_Command()
        {
            fixture.CacheSettings = s => s.WithForce();
        ...
        {
            fixture.CacheSettings = s => s.WithJson();
            var result = fixture.Run();
        ...
        {
            fixture.CacheSettings = s => s.WithLogLevel(logLevel);
            var result = fixture.Run();
        ...
        {
            fixture.CacheSettings = s => s.WithOffline();
            var result = fixture.Run();
        ...
        {
            fixture.CacheSettings = s => s.WithQuiet();
            var result = fixture.Run();
        ...
        {
            fixture.CacheSettings = s => s.WithSilent();
            var result = fixture.Run();
        ...
        {
            fixture.CacheSettings = s => s.WithVerbose();
            var result = fixture.Run();
        ...
        {
            fixture.CacheSettings = s => s.WithAllowRoot();
            var result = fixture.Run();
